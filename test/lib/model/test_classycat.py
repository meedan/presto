...
class TestClassyCat(TestCase):
    ...
    def test_schema_create(self, mock_file_exists, mock_upload_file_to_s3):
    ...
    def test_schema_lookup(self, mock_file_exists, mock_load_file_from_s3):
        ...
        mock_load_file_from_s3.return_value = json.dumps(
            {
        ...
        self.assertEqual(mock_load_file_from_s3.call_count, 1)
